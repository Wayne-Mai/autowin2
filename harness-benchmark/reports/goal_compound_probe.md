...
[
  {
    "fills": [
      {
        ...
        "notional": 9500.0,
        "order_id": "goal-compound-probe-paper_target_compound-1",
        "price": 0.8230000000000001,
        "quote_timestamp": 1779544191,
    ...
    "orders": [
      {
        "created_at": 1779544191,
        "eligible_at": 1779544191,
        "order_id": "goal-compound-probe-paper_target_compound-1",
        "signal": {
          "asset": "32270411694523539495262303868629477861017829722282576458031815333486368239544",
          "condition_id": "0x9b6fef249040fd17e9c107955b37ac2c3e923509b6b0ff01cc463a331ddeb894",
          "reason": "target_opportunity_momentum score=0.0781 exit_bid=0.8522 exit_distance=3.67% imbalance=0.16 mark_loss=0.65%",
          "side": "BUY",
          "source_tx_hashes": [],
          "source_wallets": [],
          "strategy": "paper_target_compound",
    ...
    "fills": [
      {
        ...
        "liquidity_source": "paper_run",
        "notional": 9500.0,
        "order_id": "goal-compound-probe-paper_target_near_target-2",
        "price": 0.8230000000000001,
        "quote_timestamp": 1779544191,
        "reason": "depth_fill_at_asks_plus_slippage",
        "requested_notional": 9500.0,
    ...
    "orders": [
      {
        ...
        "signal": {
          "asset": "32270411694523539495262303868629477861017829722282576458031815333486368239544",
          "condition_id": "0x9b6fef249040fd17e9c107955b37ac2c3e923509b6b0ff01cc463a331ddeb894",
          "reason": "target_opportunity_momentum score=-0.1420 exit_bid=0.9163 exit_distance=11.47% imbalance=0.16 mark_loss=0.65%",
          "side": "BUY",
          "source_tx_hashes": [],
          "source_wallets": [],
          "strategy": "paper_target_near_target",
